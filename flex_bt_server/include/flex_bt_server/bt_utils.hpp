...
#ifndef FLEX_BT_SERVER__BT_UTILS_HPP_
#define FLEX_BT_SERVER__BT_UTILS_HPP_
#include <set>
#include <string>
#include <string_view>
 ...
 */
template<>
inline geometry_msgs::msg::Point convertFromString(const BT::StringView key)
{
 ...
 */
template<>
inline geometry_msgs::msg::Quaternion convertFromString(const BT::StringView key)
{
 ...
 */
template<>
inline geometry_msgs::msg::PoseStamped convertFromString(const BT::StringView key)
{
...
convertFromString<std::chrono::milliseconds>(const BT::StringView key)
{
 ...
 */
template<>
inline std::set<int> convertFromString( BT::StringView key)
{
...
#endif  // FLEX_BT_SERVER__BT_UTILS_HPP_
