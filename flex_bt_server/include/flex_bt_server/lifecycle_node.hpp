...
#ifndef FLEX_BT_SERVER__LIFECYCLE_NODE_HPP_
#define FLEX_BT_SERVER__LIFECYCLE_NODE_HPP_
...
public:
   ...
   */
  std::shared_ptr<flex_bt::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<flex_bt::LifecycleNode>(
   ...
   */
  flex_bt::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
...
#endif  // FLEX_BT_SERVER__LIFECYCLE_NODE_HPP_
