...
#ifndef FLEX_BT_SERVER__SIMPLE_ACTION_SERVER_HPP_
#define FLEX_BT_SERVER__SIMPLE_ACTION_SERVER_HPP_
...
#include "flex_bt_server/node_thread.hpp"
// #include "flex_bt_server/node_utils.hpp"

namespace flex_bt
{

/**
 * @class flex_bt::SimpleActionServer
...
public:
    ...
    spin_thread_(spin_thread)
  {
    ...
    if (spin_thread_) {
      ...
      executor_thread_ = std::make_unique<flex_bt::NodeThread>(executor_);
    }
  }
...
protected:
  ...
  std::unique_ptr<flex_bt::NodeThread> executor_thread_;
...
#endif   // FLEX_BT_SERVER__SIMPLE_ACTION_SERVER_HPP_
